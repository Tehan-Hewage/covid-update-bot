...
APP_ID=8306908 #my.telegram.org
APP_HASH='a97521604f2186f0a0511bee9dffc96e' #my.telegram.org
BOTT='2075001612:AAHD6CZuGCvKYKgyPMTqcQXHHDa8xpgMqsw'#@botfather
...
def staat(qq):
  ...
  data = {
    ...
    "caption": "Get instant access to Corona in Sri Lanka 📊 .  Automatically retrieve the latest corona information after adding it to the @SLCovid19slbzonebot Group 🦠 . Use /help for more information. @tehan_assistant_bot ",
    "parse_mode": "HTML",
    "reply_markup": {
        "inline_keyboard": [
            [
                {
                    "text": " 💎 Our Group  ",
                    "url": "https://t.me/song_video_downloader"
                }, 
                {
                    "text": " 👨🏼‍💻 Contact Tehan",
...
async def help(event):
    await event.respond(('Type <i><b>corona</b></i> to view the latest corona news'),parse_mode='html')
    raise events.StopPropagation
